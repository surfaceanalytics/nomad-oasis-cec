![docker image](https://github.com/surfaceanalytics/nomad-oasis-cec/actions/workflows/docker-publish.yml/badge.svg)


# surfaceanalytics's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of surfaceanalytics.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/surfaceanalytics/nomad-oasis-cec.git
    cd nomad-oasis-cec
    ```
    ...
    ```sh
    curl-L -o nomad-oasis-cec.zip "https://github.com/surfaceanalytics/nomad-oasis-cec/archive/main.zip"
    unzip nomad-oasis-cec.zip
    cd nomad-oasis-cec
    ```
...
your `docker-compose.yaml` with `ghcr.io/surfaceanalytics/nomad-oasis-cec:main` for the services
...
and advanced configuration, see the [nomad-helm-charts](https://github.com/surfaceanalytics/nomad-helm-charts) repository.
...
By default, no plugins are included in this distribution. You can find a list of available NOMAD plugins [here](https://nomad-lab.eu/prod/v1/oasis/gui/search/plugins). For a list of official plugins provided by FAIRmat, please see [here](https://github.com/surfaceanalytics/.github/blob/main/profile/README.md). For inspiration, you can also check the list of [plugins that are installed on the production NOMAD deployment hosted by FAIRmat](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-distro/-/raw/main/pyproject.toml?ref_type=heads).
...
```sh
docker pull ghcr.io/surfaceanalytics/nomad-oasis-cec/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/surfaceanalytics/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/surfaceanalytics/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/surfaceanalytics/nomad-oasis-cec/manifests/main": unauthorized`
